...
class Address extends Model
{
    ...
    public function save()
    {
        ...
        $result = $sql->select("CALL sp_addresses_save(:idaddress, :idperson, :desaddress, :desnumber, :descomplement, :desdistrict, :descity, :desstate, :descountry, :deszipcode)", array(
